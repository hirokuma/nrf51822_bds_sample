...
static void on_ios_evt(ble_ios_t * p_ios, ble_ios_evt_t * p_evt)
{
    switch (p_evt->evt_type)
    {
        case BLE_IOS_INPUT_EVT_WRITE:
            APPL_LOG("[APPL]: charact written with value 0x%02x. \r\n", p_evt->params.input.value);
            break;
...
static void services_init(void)
{
    ...
    //ios_init.is_xxx_notify_supported    = true;
    ios_init.ble_ios_input_initial_value.value = 0;
    ios_init.ble_ios_output_initial_value.value = 0;
